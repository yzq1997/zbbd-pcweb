    ...
    <div>
        ...
        <a-locale-provider :locale="zhCN">
            ...
            >
                ...
                <!-- 1：搜索框，0：正常 -->
                <span slot="R_Type" slot-scope="text">
                    {{text==1?"热门推荐":"本周热搜"}}
                </span>
...
export default {
    props:['columns','tableData','loading','handleTableChange','bordered','scroll','pagination','option','rowSelection','onSelectChange','size','rowKey','expandAble','diy'],
    created(){
